...
namespace Codefirst02.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PersonID,PersonName,Address,Company,Adress")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PersonID,PersonName,Address,Company,Adress")] Employee employee)
        {
            if (ModelState.IsValid)
            {
